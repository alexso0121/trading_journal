...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("trading_journel_app.Domain.Entities.ChecklistConfigItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("checklist_config_items", (string)null);
                });
            ...
            modelBuilder.Entity("trading_journel_app.Domain.Entities.DailyJournalChecklistItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("DailyJournalId", "Sequence")
                        .IsUnique();

                    b.ToTable("daily_journal_checklist_items", (string)null);
                });

            modelBuilder.Entity("trading_journel_app.Domain.Entities.StoredFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("UserId", "OwnerType", "OwnerEntityId");
            ...
            modelBuilder.Entity("trading_journel_app.Domain.Entities.DailyJournalChecklistItem", b =>
                {
                    b.HasOne("trading_journel_app.Domain.Entities.ChecklistConfigItem", null)
                        .WithMany()
                        .HasForeignKey("ConfigItemId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("trading_journel_app.Domain.Entities.DailyJournal", null)
